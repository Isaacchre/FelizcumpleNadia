...
function injectWow() {
  ...
  if (wows === 10) {
    lengthEl.innerText = "Ñam Ñam"
  }

  if (wows === 50) {
    lengthEl.innerText = "Ñam Ñam Ñam"
  }

  if (wows === 100) {
    lengthEl.innerText = "mucho Ñam"
  }

  if (wows === 150) {
    lengthEl.innerText = "gran mucho Ñam" // Cambiado de 'largo mucho Ñam'
  }

  if (wows === 250) {
    lengthEl.innerText = "enorme mucho Ñam" // Cambiado de 'muy largo mucho Ñam'
  }

  if (wows === 500) {
    lengthEl.innerText = "Ñam enorme mucho Ñam"
  }

  if (wows === 1000) {
    lengthEl.innerText = "mucho Ñam enorme mucho Ñam!"
  }
...
  if (wows === 10000) {
    lengthEl.innerText = "muchísimos Ñam asombro"
  }

  if (wows === 30000) {
    lengthEl.innerText = "asombro Ñam no olvides imprimir!"
  }

  if (wows === 50000) {
    lengthEl.innerText = "ÑamÑamÑamÑamÑamÑamÑamÑamÑamÑamÑamÑamÑam"
  }

  if (wows === 80000) {
    lengthEl.innerText = "ÑamÑamÑamÑamÑamÑamÑamÑamÑamÑamÑamÑamÑameeeeeeeeee"
  }
